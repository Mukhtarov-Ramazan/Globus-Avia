  ...
  <div class="container">
    <section class="mt-5">
      ...
      <table class="table table-bordered text-white bg-secondary">
        ...
        <tr>
          <td class="test-5-fc">{{FLIGHTS.data.flights_to[this.$route.query.indexTo].flight_code}}</td>
          <td>
          ...
          <td class="test-5-to">
            <span class="test-5-to-cn">{{FLIGHTS.data.flights_to[this.$route.query.indexTo].to.date}}</span>,
            <span class="test-5-to-an">{{FLIGHTS.data.flights_to[this.$route.query.indexTo].to.airport}}</span>
          </td>
          <td class="test-5-at">{{FLIGHTS.data.flights_to[this.$route.query.indexTo].to.time}}</td>
        ...
        <tr>
          ...
          <td class="test-5-to">
            <span class="test-5-to-cn">{{FLIGHTS.data.flights_back[this.$route.query.indexBack].to.date}}</span>,
            <span class="test-5-to-an">{{FLIGHTS.data.flights_back[this.$route.query.indexBack].to.airport}}</span>
          </td>
          <td class="test-5-at">{{FLIGHTS.data.flights_back[this.$route.query.indexBack].to.time}}</td>
        ...
        <tr>
          ...
          <td colspan="1" class="text-right test-5-price">12333</td>
        </tr>
      </table>
    </section>
